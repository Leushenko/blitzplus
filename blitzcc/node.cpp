...
std::vector<std::string> Node::const_strings;
...
/////////////////////////////////////////////////////////
// create a stmt-type function call with std::string result //
/////////////////////////////////////////////////////////
TNode *Node::strcall( const std::string &func,TNode *a0,TNode *a1,TNode *a2 ){
	++tmp_strs;
	int size=0;
	TNode *t=0;
	if( a0 ){
